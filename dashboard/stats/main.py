...
from stats.datatypes import ProjectResponse, StatResponse
from stats.graphql import Query
from strawberry.fastapi import GraphQLRouter

schema = strawberry.federation.Schema(
    query=Query, enable_federation_2=True, types=[ProjectResponse, StatResponse]
)
